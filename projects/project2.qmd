...
<div style="border: 1px solid #ddd; border-radius: 8px; padding: 2.5rem; text-align: center; background: #f9f9f9;">
  <p style="font-size: 1.1rem; margin-bottom: 0.5rem; color: #444;">Deploy <code>projects/mimic/app.py</code> to Posit Connect, then the demo will be available here.</p>
  <p style="font-size:0.85rem;color:#888;">Run locally: <code>cd projects/mimic && python -m shiny run app.py --port 8001</code></p>
</div>
```
